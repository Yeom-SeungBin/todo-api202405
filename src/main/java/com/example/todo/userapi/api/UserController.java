...
public class UserController {
    ...
    // 메서드 호출 전에 검사 -> 요청 당시 토큰에 있는 user 정보가 ROLE_COMMON 이라는 권한을 가지고 있는지를 검사.
    ...
    @PostMapping("/refresh")
    public ResponseEntity<?> response(@RequestBody Map<String, String> tokenRequest) {
    ...
    private MediaType findExtensionAndGetMediaType(String filePath) {
        ...
        // 파일 경로에서 확장자 추출
        // C:/todo_upload/gdjkagjdlkagjldkjalgjlgk_abc.jpg
